...
@section('content')
    ...
    <div id="review"
        class="section flex flex-col gap-5">
        @foreach ($reviews as $review)
        <div class="reviewflex flex-col flex-1 px-4 py-2.5 gap-4 border-2 border-gray-500/20 rounded-md bg-lime-700/10 ">
            ...
            <div class="review-container py-3 border-t-(--secondary) border-t flex w-full gap-2 max-[850px]:flex-col">
                ...
                <div class="review-rating h-fit border-(--secondary) border-2 bg-(--secondary)/20 rounded-md flex flex-col">
                ...
                <div class="review-reviewer  flex flex-col">
                    <div class="flex flex-col gap-3">
                        ...
                        <span class="flex gap-2 items-center">
                            <img class="w-10 h-10 aspect-square object-cover rounded-full" src="{{ $review->reviewer->logo }}" alt="">
