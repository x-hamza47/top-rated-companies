            ...
            @for ($i = 0; $i < 10; $i++)
                <div
                    ...
                    <div
                        ...
                        {{-- ! Column 3 --}}
                        <div class="text-sm ">
                            <p class="break-word lg:line-clamp-6 md:line-clamp-5 line-clamp-4">Lorem ipsum, dolor sit amet
                            ...
                            <span class="text-blue-500 font-medium inline">See all 26 Projects</span>
                        </div>
                    </div>
                    {{-- Info: Detail Boxes --}}
