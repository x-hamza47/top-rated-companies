...
@section('content')
    ...
    {{-- ! Services Section --}}
  <div class="section flex flex-col p-[50px] max-[720px]:p-5">
        <h2 class="text-4xl font-bold">Browse <span class="text-lime-700">Services</span></h2>
        <p>Unfold a broad range of professional services that are tailored to different business needs. Each
            category
        ...
        <div class="card-wrapper flex flex-wrap items-center justify-between my-4 gap-10">
            <div class="card w-[30%] max-[1140px]:w-[45%] max-[940px]:w-full relative rounded-md outline-2 outline-(--secondary) flex flex-col p-2 gap-2">
                <div class="card-title flex items-center gap-2">
                    <button class="bg-lime-800 text-white p-2.5 rounded-md">
                        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="currentColor">
                            <path class="fill-(--primary)" stroke="white" stroke-width="1" d="M24 10.935v2.131l-8 3.947v-2.23l5.64-2.783-5.64-2.79v-2.223l8 3.948zm-16 3.848l-5.64-2.783 5.64-2.79v-2.223l-8 3.948v2.131l8 3.947v-2.23zm7.047-10.783h-2.078l-4.011 16h2.073l4.016-16z"></path>
                        </svg>
            ...
            <div class="card w-[30%] max-[1140px]:w-[45%] max-[940px]:w-full relative rounded-md outline-2 outline-(--secondary) flex flex-col p-2 gap-2">
                <div class="card-title flex items-center gap-2">
                    <button class="bg-lime-800 text-white p-2.5 rounded-md">
                        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="currentColor">
                            <path class="fill-(--primary)" d="M22 2v20h-20v-20h20zm2-2h-24v24h24v-24zm-4 7h-8v1h8v-1zm0 5h-8v1h8v-1zm0 5h-8v1h8v-1zm-10.516-11.304l-.71-.696-2.553 2.607-1.539-1.452-.698.71 2.25 2.135 3.25-3.304zm0 5l-.71-.696-2.552 2.607-1.539-1.452-.698.709 2.249 2.136 3.25-3.304zm0 5l-.71-.696-2.552 2.607-1.539-1.452-.698.709 2.249 2.136 3.25-3.304z"></path>
                        </svg>
            ...
            <div class="card w-[30%] max-[1140px]:w-[45%] max-[940px]:w-full relative rounded-md outline-2 outline-(--secondary) flex flex-col p-2 gap-2">
                <div class="card-title flex items-center gap-2">
                    <button class="bg-lime-800 text-white p-2.5 rounded-md">
                        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="currentColor">
                            <path class="fill-(--primary)" d="M19 17c0 1.104-.896 2-2 2h-11c-1.104 0-2-.896-2-2v-11c0-1.104.896-2 2-2h11c1.104 0 2 .896 2 2v11zm-11 3v3h-1v-3h1zm4 0v3h-1v-3h1zm2 0v3h-1v-3h1zm-4 0v3h-1v-3h1zm6 0v3h-1v-3h1zm-8-20v3h-1v-3h1zm4 0v3h-1v-3h1zm2 0v3h-1v-3h1zm-4 0v3h-1v-3h1zm6 0v3h-1v-3h1zm4 15h3v1h-3v-1zm0-4h3v1h-3v-1zm0-2h3v1h-3v-1zm0 4h3v1h-3v-1zm0-6h3v1h-3v-1zm-20 8h3v1h-3v-1zm0-4h3v1h-3v-1zm0-2h3v1h-3v-1zm0 4h3v1h-3v-1zm0-6h3v1h-3v-1z"></path>
                        </svg>
