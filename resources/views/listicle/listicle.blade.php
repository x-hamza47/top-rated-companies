    ...
    <div class=" w-full max-w-[1920px] flex flex-col flex-wrap md:p-10 lg:p-12 p-4 sm:p-7">
        ...
        <div class="company-wrapper flex flex-col gap-4 mt-2">
            @forelse ($companies as $company)
                <div class="company bg-(--color-surface) outline-2 outline-gray-500/55 hover:outline-(--color-primary) rounded-md px-3 py-3 md:px-3.5 md:py-3.5 lg:px-6 lg:py-5 hover:scale-[1.01] hover:outline-grap-800 hover:shadow-2xl transition-all duration-300 relative"
                    id="{{ $company->id }}">
