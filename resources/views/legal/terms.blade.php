...
@section('content')
<section class="bg-(--color-background) w-full min-h-screen py-10 px-4 md:px-10 mt-20">

    <div class="max-w-4xl mx-auto bg-(--color-surface) shadow-sm rounded-2xl p-6 md:p-10">

        {{-- Title --}}
        <h1 class="text-3xl font-bold text-(--color-primary) mb-2">
            Terms & Conditions
        </h1>
        ...
        {{-- Intro --}}
        <p class="text-(--color-text) leading-relaxed mb-6">
            By using our platform, you agree to the following terms and conditions. Please read them carefully.
        </p>

        {{-- Section: Use of Platform --}}
        <div class="mb-6">
            <h2 class="text-xl font-semibold text-(--color-primary-hover) mb-3">
                Use of Platform
            </h2>
            <ul class="list-disc pl-5 space-y-2 text-(--color-text)">
