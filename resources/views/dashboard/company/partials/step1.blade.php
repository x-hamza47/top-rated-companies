        ...
        <div>
            <div class="inp-field w-full ">
                ...
                <span class="relative h-11">
                    ...
                    <i class="fa-solid fa-comment-dots absolute left-3 top-1/2 -translate-y-1/2 text-gray-400"></i>
                </span>
                @error('tagline')
                    <span class="error">
                        <i class="fa-solid fa-circle-exclamation error-icon"></i>
            ...
            <div class="inp-field w-full ">
                ...
                <span class="relative">
                    <input type="text" placeholder="https://company.com" name="slug"
                        class="rounded-md text-(--color-muted) w-full h-full border-2 border-gray-400/40  outline-none placeholder:text-gray-400 pl-10 pr-9 py-3 @error('slug') invalid-input @enderror"
            ...
            <div class="inp-field w-full ">
                ...
                <span class="relative">
                    <input type="number" placeholder="2018" name="founded"
                        class="rounded-md w-full h-full border-2 border-gray-400/40 focus:border-(--color-primary) outline-none placeholder:text-gray-400 pl-10 pr-9 py-3 @error('founded') invalid-input @enderror"
